...
sudo sed -i 's/static{this\.AppTitle="Grafana"}/static{this.AppTitle="gadgetini"}/g' 3729.*.js
sudo sed -i 's/static{this\.LoginTitle="Welcome to Grafana"}/static{this.LoginTitle="Welcome to gadgetini"}/g' 3729.*.js
sudo sed -i 's/{text:"Grafana"}/{text:"gadgetini"}/g' 3729.*.js
